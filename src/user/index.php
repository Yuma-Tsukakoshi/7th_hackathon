    ...
    <section class="member_status_container">
      <div class="older_members">
        ...
        <div class="wrap slide-paused" ontouchstart="">
          <ul class="icon_slide">
            <li class="content" onclick="userdisp(this)" data-uid="1"><img src="../assets/img/LINE_ALBUM_3期生アイコン画像_230917_1.jpg" alt="">3.0 木村宥哉<div class="anchor_img"></div>
            </li>
...
<script>
  function userdisp(button) {
    const Btn = $(button);
    let uid = Btn.attr('data-uid');
    console.log(uid);

    const param = uid;
    const url = "/user/user_info/user_disp.php?id=" + param;
